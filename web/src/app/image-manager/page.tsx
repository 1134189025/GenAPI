...
function ImageManagerContent() {
  ...
  const dateRangeLabel = startDate || endDate ? `${startDate || "起始"} - ${endDate || "现在"}` : "全部时间";
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button onClick={() => void loadImages()} disabled={isLoading} className="h-10 rounded-xl bg-slate-950 px-4 text-white hover:bg-slate-800">
      ...
      <DataPanel
        ...
        toolbar={
          <>
            ...
            <Button variant="ghost" className="h-8 rounded-lg px-3 text-slate-500" onClick={() => void loadImages()} disabled={isLoading}>
