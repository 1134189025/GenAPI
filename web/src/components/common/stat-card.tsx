...
export function StatCard({
  ...
  return (
    <div className={cn("rounded-3xl border border-white/75 bg-white/88 p-5 shadow-[0_20px_60px_-34px_rgba(15,23,42,0.35)] backdrop-blur", className)}>
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-1 truncate text-2xl font-black tracking-tight text-slate-950">{value}</div>
